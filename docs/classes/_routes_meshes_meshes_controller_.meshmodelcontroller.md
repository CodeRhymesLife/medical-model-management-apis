[medical-model-manager-apis](../README.md) > ["routes/meshes/meshes.controller"](../modules/_routes_meshes_meshes_controller_.md) > [MeshModelController](../classes/_routes_meshes_meshes_controller_.meshmodelcontroller.md)
